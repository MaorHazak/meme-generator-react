...
state = {
	topText: "",
	bottomText: "",
	allText: bottomText, topText, //check
	allMemeImgs: [],
	randomImg: ""
};
...
render() {
	...
	<div>
		...
		>
			<option name = 'black' className="black-color" value={black}>black</option>
			<option name = 'white' className="white-color" value={white}>white</option>
		</select>
